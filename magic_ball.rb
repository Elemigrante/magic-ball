...
puts hello.sample # Sample - взять случайное значение из массива 'hello' и вывести его.
sleep(3) # Пауза перед выводом.
puts
puts answers.sample # Вывод случайного значения из массива 'answers'